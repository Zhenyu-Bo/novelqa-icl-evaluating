...
def build_prompt_icl(chapter_content: str, question_options: str) -> str:
    ...
    2. Identify and list all evidence from the chapter that is directly, explicitly, and unambiguously relevant to the question. Do not over-interpret, speculate, or use implied or ambiguous content as evidence just to find evidence! Because you can just say "No relevant evidence found in this chapter." if you cannot find any direct and explicit evidence. Do not include evidence that merely hints, suggests, or implies the answer. Only use evidence that clearly and unambiguously states the fact.
    ...
    4. If the question involves counting occurrences (e.g., "How many times does xxx appear?"), carefully check whether different pieces of evidence refer to the same event. If so, avoid double-counting and explain your reasoning for deduplication.
    ...
    - Deduplication Reasoning: [Your reasoning for deduplication, if any]
...
def build_prompt_final(question: str) -> str:
    ...
    2. Deduplication Reasoning: [Your reasoning for deduplication, if any]
    ...
    5. Final Choice:
       <answer>my final answer: A, B, C, or D</answer>(for example: <answer>my final answer: A</answer>)
